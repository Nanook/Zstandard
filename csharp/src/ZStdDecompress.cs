...
using ZSTD_DCtx = RTMath.ZStd.ZStdDecompress.ZSTD_DCtx_s;

using HUF_DTable = System.UInt32;
using BIT_DStream_t = RTMath.ZStd.BitStream.BIT_DStream_t;
using XXH64_state_t = RTMath.ZStd.XXH64_state_s;

using static RTMath.ZStd.Mem;
using static RTMath.ZStd.BitStream;
using static RTMath.ZStd.ZStd;
using static RTMath.ZStd.ZStdInternal;
using static RTMath.ZStd.ZStdErrors;
using static RTMath.ZStd.EntropyCommon;
using static RTMath.ZStd.HufDecompress;
using static RTMath.ZStd.XxHash;
using static RTMath.ZStd.Huf;
